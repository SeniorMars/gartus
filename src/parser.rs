...
impl Parser{
    ...
    /// let porygon = Parser::new("./porygon_script", 512, 512, 255, purplish);
    /// ```
    ...
    /// let porygon = Parser::new_with_bg("./porygon_script", 512, 512, 255, purplish, outline);
    /// ```
    ...
    /// let purplish = Pixel::new(17, 46, 81);
    /// let outline = Pixel::new(235, 219, 178);
    /// let mut porygon = Parser::new_with_bg("./porygon_script", 512, 512, 255, purplish, outline);
    /// porygon.parse_file();
    /// ```

/// The standard Utah Teapot vertex coordinates.
pub const TEAPOT_VERTICES: [(f64, f64, f64); 306] = [
    (1.4, 0.0, 2.4), (1.4, -0.784, 2.4), (0.78, -1.4, 2.4), (0.0, -1.4, 2.4),
...
/// The standard Utah Teapot Bezier patch indices (0-based).
pub const TEAPOT_PATCHES: [[usize; 16]; 32] = [
